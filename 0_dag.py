...
def print_total_throughput(**context):
    ...
    task_list = []
    for task in ['extract_transform_1', 'extract_transform_2', 'processor_1', 'processor_2', 'processor_3', 'processor_4', 'classifier_1', 'classifier_2', 'classifier_3']:
...
start_task >> [extract_transform_1, extract_transform_2]
extract_transform_1 >> [processor_1, processor_2, processor_3] >> classifier_1
extract_transform_2 >> [processor_2, processor_3, processor_4] >> classifier_2
[processor_1, processor_2, processor_3, processor_4] >> classifier_3
[classifier_1, classifier_2, classifier_3] >> end_task